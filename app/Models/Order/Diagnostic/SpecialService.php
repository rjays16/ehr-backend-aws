...
class SpecialService implements DiagnosticServiceInterface
{
    ...
    {
        return is_null($this->service->labPriceLatest)? 0 : $this->service->labPriceLatest->price;
    }
    ...
    public static function getSearchProvider($query, $options = [])
    {
        ...
        $criteria->addCondition('group.group_id IN("SPL", "SPC", "ECHO", "CATH")');
