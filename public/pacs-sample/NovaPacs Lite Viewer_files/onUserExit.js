...
(function($) {
    ...
    var userMovingWithinSite = function() {
	...
	$.fn.onUserExit = function(options) {		
		...
		$("form").each(function() {
		    ...
		    obj.bind("submit", null, function() { userMovingWithinSite(); });
		});		

		// for Refresh Detection
	    $(document).bind("keydown", null, interceptKeyDown);
	    $(document).bind("keyup", null, interceptKeyUp);
	    $(document).bind("keypress", null, interceptKeyPress);	
