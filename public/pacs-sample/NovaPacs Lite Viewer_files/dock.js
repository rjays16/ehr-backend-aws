...
var enlargeSteps	= 10;	// Number of steps used to enlarge an element
var enlargeStepSize	= 2;	// How many pixels are added to the width of an
							// element in each enlargement step.
var reduceStepSize	= 2;	// How many pixels are subtracted from the width
...
*******************************************************************************/
function enlarge(element, thumb)
{
	if(thumb!=null)
		enlargeSteps = 10;
	else
